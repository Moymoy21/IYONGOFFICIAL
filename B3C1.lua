...
-- ====================================================================
-- 2. AKARI SPIDER CORE CONFIGURATIONS & VARIABLES (FIXED VERSION)
-- ====================================================================
local Players = game:GetService("Players")
local Workspace = game:GetService("Workspace")
local RunService = game:GetService("RunService")
local StarterGui = game:GetService("StarterGui") -- NAAYOS: Idinagdag ang kulang na service declaration
...
-- =========================================================================
-- ANTI-GRAVITY ENGINE (Pinatibay ang dynamic character reference check)
-- =========================================================================
if not _G.AntiGravityActive then
    ...
    RunService.Heartbeat:Connect(function()
        ...
        if _G.AntiGravityActive and currentCharacter and currentHumanoid and currentHRP then
            currentHumanoid:ChangeState(Enum.HumanoidStateType.Physics)
            if currentHRP:IsA("BasePart") then
...
-- PAALALA: Ang hiwalay na Anti-Akari Radar loop ay inalis na natin dito dahil 
-- mas pinaganda at pinagsama na natin ito sa loob ng "Akari Box & Name ESP" toggle 
-- para iwas-lag at iwas-banggaan ng magkaibang code sa background execution.

-- =========================================================================
-- BUTTONS REGISTRATION
-- =========================================================================

-- BUTTON 1: SPIDER CYCLE (Garantisadong Dynamic at Ligtas)
...
-- BUTTON 2: EMERGENCY STOP & SAFEZONE (Walang Error)
